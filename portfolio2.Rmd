...
```
Looking at the names of the movies, in the numbers.com data names that are too long are replaced with "&hellip;" instead of the rest of the title. In the box office data, this is not done and all of the movie names are complete.
...
combined <- ggarrange(numbers.line, boxoffice.line,
                        labels = c("Number.com", "Box Office"),
                         ncol = 1, nrow = 2)
```
It looks like the change in movie gross over the month of January 2010 for both the numbers.com and box office data are the same. However, you can see in the list of movies that they are not the same
...
```
In 44% of PPD shootings PPD officers transport the individuals they shoot to the nearest hospitals.
...
setwd("/Users/briannafisher/Dropbox/Github/BriannaFisher/")
dem <- readRDS("data/acs-2019-demographics.RDS")
```
...
library(rio)
setwd("/Users/briannafisher/Dropbox/Github/BriannaFisher/")
marist <- rio::import("data/marist-jan21.DTA")
```
...
#read in data
setwd("/Users/briannafisher/Dropbox/Github/BriannaFisher/")
gov <- import("data/Government Shutdown Poll Dataset.sav")
...
require(stringr)
require(dplyr)
genfor <- import("data/genforward sept 2017.sav")
...
setwd("/Users/briannafisher/Dropbox/Github/BriannaFisher/")
census <- read.csv("data/Names_2010Census.csv")
...
setwd("/Users/briannafisher/Dropbox/Github/BriannaFisher/")
genfor <- load("data/gen-forward.RData")
...
#load in data 
setwd("/Users/briannafisher/Dropbox/Github/BriannaFisher/")
poll <- import("data/july-2019-sm-poll.sav")
...
#loading in the data
setwd("/Users/briannafisher/Dropbox/Github/BriannaFisher/")
temp <- read.csv("data/nyc-central-park-temps.csv")
...
setwd("/Users/briannafisher/Dropbox/Github/BriannaFisher/")
prec <- read.csv("data/nyc-central-park-precipitation.csv")
...
library(ggthemes)
setwd("/Users/briannafisher/Dropbox/Github/BriannaFisher/")
load("data/election-data-for-graph.RData")
...
setwd("/Users/briannafisher/Dropbox/Github/BriannaFisher/")
risk <- read.csv("data/philly-youth-risk.csv")
require(tidyr)
require(tidyverse)
...
zips <- read_sf("/Users/briannafisher/Dropbox/PSCI 207/Problem Set 6/Zipcodes_Poly")
...
#load in the data
setwd("/Users/briannafisher/Dropbox/Github/BriannaFisher/")
data <- rio::import("data/pa-survey-data.SAV")
...
#loading in the data
setwd("/Users/briannafisher/Dropbox/Github/BriannaFisher/")
survey <- rio::import("data/pa-survey-data.SAV")
```
...
#load in the data
setwd("/Users/briannafisher/Dropbox/Github/BriannaFisher/")
zips <- read.csv("data/zip-codes.csv")
county <- readRDS("data/PA-county-shapefile.RDS")
